 ...
 */
@ApiModel(description = "An event recording that the URL of a tab has changed.")
@JsonPropertyOrder({
  TabUrlChanged.JSON_PROPERTY_TAB_ID,
  TabUrlChanged.JSON_PROPERTY_URL
})
...
public class TabUrlChanged extends EventPayload {
  ...
  public TabUrlChanged tabId(UUID tabId) {
    this.tabId = tabId;
    return this;
  }
  ...
  **/
  ...
  public TabUrlChanged url(URI url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @ApiModelProperty(required = true, value = "The URL the page that the tab was on.")
   ...
   */
  @JsonAnySetter
  public TabUrlChanged putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this TabUrlChanged object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    TabUrlChanged tabUrlChanged = (TabUrlChanged) o;
    return Objects.equals(this.tabId, tabUrlChanged.tabId) &&
        Objects.equals(this.url, tabUrlChanged.url)&&
        Objects.equals(this.additionalProperties, tabUrlChanged.additionalProperties) &&
        super.equals(o);
  }
...
static {
  ...
  mappings.put("TabUrlChanged", TabUrlChanged.class);
  JSON.registerDiscriminator(TabUrlChanged.class, "@type", mappings);
}
}
