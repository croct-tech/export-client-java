 ...
 */
@ApiModel(description = "An event recording that a page was loaded.")
@JsonPropertyOrder({
...
public class PageLoaded extends EventPayload {
  ...
  **/
   ...
   * @return title
  **/
  @ApiModelProperty(required = true, value = "The title of the page.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The last time the page was modified.")
