 ...
 */
@ApiModel(description = "An event recording that a shopping cart was modified.")
@JsonPropertyOrder({
...
public class ProductViewed extends EventPayload {
  ...
  public ProductViewed product(ProductDetails product) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductViewed productViewed = (ProductViewed) o;
    return Objects.equals(this.product, productViewed.product)&&
        Objects.equals(this.additionalProperties, productViewed.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(product, super.hashCode(), additionalProperties);
  }
