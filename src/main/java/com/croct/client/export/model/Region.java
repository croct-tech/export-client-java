 ...
 */
@ApiModel(description = "A subsection of a country, typically a state or province.")
@JsonPropertyOrder({
...
public class Region {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The subdivision name, non-empty. For example, \"Sao Paulo\".")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The 2-letter code as defined by the ISO 3166-2 standard. For example, \"SP\".")
