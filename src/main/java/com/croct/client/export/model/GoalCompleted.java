 ...
 */
@ApiModel(description = "An event recording a completed activity, such as a purchase.")
@JsonPropertyOrder({
...
public class GoalCompleted extends EventPayload {
   ...
   * @return goalId
  **/
  @ApiModelProperty(required = true, value = "The ID of the goal.")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The monetary value associated to the completion of the goal. This can represent an estimated value or a symbolic value. For example, if the sales team can close 10% of people who sign up for a newsletter, and the average transaction is $500, then a possible value for newsletter sign-ups can be $50 (i.e., 10% of $500).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The currency in which the monetary value is expressed. The currency should be specified using the 3-letter currency codes defined by the ISO 4217 standard. For currencies having no official recognition in ISO 4217, as is the case with cryptocurrencies, it is allowed the use of non-ISO codes adopted locally or commercially. For example, \"BRL\" for Brazilian real or \"BTC\" for Bitcoin.")
