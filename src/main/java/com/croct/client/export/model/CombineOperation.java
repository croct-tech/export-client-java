 ...
 */
@JsonPropertyOrder({
  CombineOperation.JSON_PROPERTY_TYPE,
  CombineOperation.JSON_PROPERTY_PATH,
  CombineOperation.JSON_PROPERTY_VALUE
})
...
public class CombineOperation {
  ...
  public enum TypeEnum {
    COMBINE(String.valueOf("combine"));
  ...
  public CombineOperation type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public CombineOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public CombineOperation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this CombineOperation object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class CombineOperation {\n");
