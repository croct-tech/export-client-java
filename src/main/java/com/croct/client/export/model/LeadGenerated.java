...
@JsonPropertyOrder({
  ...
  LeadGenerated.JSON_PROPERTY_PATCH
})
...
public class LeadGenerated extends EventPayload {
  ...
  public LeadGenerated value(@javax.annotation.Nullable Double value) {
    this.value = value;
    return this;
  }
  ...
  public LeadGenerated patch(@javax.annotation.Nullable AtomicPatch patch) {
    this.patch = patch;
    return this;
  }
