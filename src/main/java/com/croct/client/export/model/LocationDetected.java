 ...
 */
@ApiModel(description = "An event recording that the location of a user was detected.")
@JsonPropertyOrder({
  LocationDetected.JSON_PROPERTY_LOCATION
})
...
public class LocationDetected extends EventPayload {
  public static final String JSON_PROPERTY_LOCATION = "location";
  private Location location;


  public LocationDetected location(Location location) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public LocationDetected putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this LocationDetected object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LocationDetected locationDetected = (LocationDetected) o;
    return Objects.equals(this.location, locationDetected.location)&&
        Objects.equals(this.additionalProperties, locationDetected.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(location, super.hashCode(), additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocationDetected {\n");
...
static {
  ...
  mappings.put("LocationDetected", LocationDetected.class);
  JSON.registerDiscriminator(LocationDetected.class, "@type", mappings);
}
}
