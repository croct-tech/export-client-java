 ...
 */
@JsonPropertyOrder({
  DecrementOperation.JSON_PROPERTY_TYPE,
  DecrementOperation.JSON_PROPERTY_PATH,
  DecrementOperation.JSON_PROPERTY_VALUE
})
...
public class DecrementOperation {
  ...
  public enum TypeEnum {
    DECREMENT(String.valueOf("decrement"));
  ...
  public DecrementOperation type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public DecrementOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public DecrementOperation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this DecrementOperation object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class DecrementOperation {\n");
