 ...
 */
@ApiModel(description = "The context of the web client at the time the event was tracked.")
@JsonPropertyOrder({
...
public class WebContext extends EventContext {
  ...
  **/
   ...
   * @return url
  **/
  @ApiModelProperty(required = true, value = "The URL of the page that the client was on.")
