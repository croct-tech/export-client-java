 ...
 */
@JsonPropertyOrder({
  EventPayload.JSON_PROPERTY_TYPE
})
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = AudienceMatched.class, name = "audienceMatched"),
  @JsonSubTypes.Type(value = CampaignDetected.class, name = "campaignDetected"),
  ...
  @JsonSubTypes.Type(value = InterestShown.class, name = "interestShown"),
  @JsonSubTypes.Type(value = LeadGenerated.class, name = "leadGenerated"),
  @JsonSubTypes.Type(value = LinkOpened.class, name = "linkOpened"),
  ...
  @JsonSubTypes.Type(value = PostViewed.class, name = "postViewed"),
  @JsonSubTypes.Type(value = ProductAbandoned.class, name = "productAbandoned"),
  @JsonSubTypes.Type(value = ProductOrdered.class, name = "productOrdered"),
  @JsonSubTypes.Type(value = ProductViewed.class, name = "productViewed"),
  @JsonSubTypes.Type(value = SessionAttributesChanged.class, name = "sessionAttributesChanged"),
  @JsonSubTypes.Type(value = SessionClosed.class, name = "sessionClosed"),
  @JsonSubTypes.Type(value = SessionMerged.class, name = "sessionMerged"),
  ...
  @JsonSubTypes.Type(value = UserClicked.class, name = "userClicked"),
  @JsonSubTypes.Type(value = UserProfileChanged.class, name = "userProfileChanged"),
  @JsonSubTypes.Type(value = UserScrolled.class, name = "userScrolled"),
...
public class EventPayload {
  ...
  public EventPayload type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  static {
    ...
    mappings.put("campaignDetected", CampaignDetected.class);
    ...
    mappings.put("linkOpened", LinkOpened.class);
    ...
    mappings.put("sessionAttributesChanged", SessionAttributesChanged.class);
    mappings.put("sessionClosed", SessionClosed.class);
    mappings.put("sessionMerged", SessionMerged.class);
    mappings.put("sessionStarted", SessionStarted.class);
