...
public class UserResponse {
  ...
  public UserResponse items(@javax.annotation.Nonnull List<User> items) {
    this.items = items;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_ITEMS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<User> items) {
    this.items = items;
  }


  public UserResponse nextCursor(@javax.annotation.Nonnull String nextCursor) {
