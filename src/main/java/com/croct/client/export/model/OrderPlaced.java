...
import com.croct.client.export.model.Order;
 ...
 */
@ApiModel(description = "An event recording that an order was placed.")
@JsonPropertyOrder({
  OrderPlaced.JSON_PROPERTY_ORDER
})
...
public class OrderPlaced extends EventPayload {
  public static final String JSON_PROPERTY_ORDER = "order";
  private Order order;


  public OrderPlaced order(Order order) {
    this.order = order;
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public OrderPlaced putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this OrderPlaced object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OrderPlaced orderPlaced = (OrderPlaced) o;
    return Objects.equals(this.order, orderPlaced.order)&&
        Objects.equals(this.additionalProperties, orderPlaced.additionalProperties) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(order, super.hashCode(), additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderPlaced {\n");
...
static {
  ...
  mappings.put("OrderPlaced", OrderPlaced.class);
  JSON.registerDiscriminator(OrderPlaced.class, "@type", mappings);
}
}
