 ...
 */
@ApiModel(description = "An event recording that a page was opened.")
@JsonPropertyOrder({
...
public class PageOpened extends EventPayload {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The user-agent of the client.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "An ordered list of the user's preferred languages.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The URI of the page that linked to the page that was opened. The value is null when the user navigated to the page directly (not through a link, but by using a bookmark, for example).")
