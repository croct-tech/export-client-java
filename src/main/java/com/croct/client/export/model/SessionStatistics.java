 ...
 */
@ApiModel(description = "The aggregated statistics of the session.")
@JsonPropertyOrder({
...
public class SessionStatistics {
  ...
  **/
  ...
  @ApiModelProperty(value = "The total number of page views.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The total number of orders placed.")
