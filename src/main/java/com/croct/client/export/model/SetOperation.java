 ...
 */
@JsonPropertyOrder({
  SetOperation.JSON_PROPERTY_TYPE,
  SetOperation.JSON_PROPERTY_PATH,
  SetOperation.JSON_PROPERTY_VALUE
})
...
public class SetOperation {
  ...
  public SetOperation type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SetOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public SetOperation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }

  /**
   * The value to set. Can be any JSON value.
   * @return value
   */
  @javax.annotation.Nullable
  ...
  /**
   * Return true if this SetOperation object is equal to o.
   */
  @Override
