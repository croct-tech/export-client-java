 ...
 */
@JsonPropertyOrder({
  IncrementOperation.JSON_PROPERTY_TYPE,
  IncrementOperation.JSON_PROPERTY_PATH,
  IncrementOperation.JSON_PROPERTY_VALUE
})
...
public class IncrementOperation {
  ...
  public IncrementOperation type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public IncrementOperation path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public IncrementOperation value(@javax.annotation.Nullable Object value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this IncrementOperation object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class IncrementOperation {\n");
