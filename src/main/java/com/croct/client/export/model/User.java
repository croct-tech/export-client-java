...
public class User {
  ...
  public User activities(@javax.annotation.Nullable List<String> activities) {
    this.activities = activities;
    return this;
  }

  public User addActivitiesItem(String activitiesItem) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ACTIVITIES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setActivities(@javax.annotation.Nullable List<String> activities) {
    this.activities = activities;
  }


  public User interests(@javax.annotation.Nullable List<String> interests) {
