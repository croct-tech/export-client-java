 ...
 */
@ApiModel(description = "The available information about a device.")
@JsonPropertyOrder({
...
public class Device {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The name of the device, non-empty. For example, \"Mac\", \"iPhone\" or \"Nexus 10\".")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The vendor of the device, non-empty. For example, \"Apple\", \"Samsung\" or \"LG\".")
