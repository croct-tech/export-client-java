 ...
 */
@ApiModel(description = "A shopping cart in an online store.")
@JsonPropertyOrder({
...
public class Cart {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The currency in which the monetary values are expressed in the shopping cart. The currency should be specified using the 3-letter currency codes defined by the ISO 4217 standard. For currencies having no official recognition in ISO 4217, as is the case with cryptocurrencies, it is allowed the use of non-ISO codes adopted locally or commercially. For example, \"BRL\" for Brazilian real or \"BTC\" for Bitcoin.")
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "The list of items in the shopping cart.")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The total of all items and quantities in the shopping cart including applied item promotions. Applied order discounts, estimated shipping, and applied shipping discounts should be excluded from the subtotal amount.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The total shipping price for the items in the shopping cart, including any handling charges.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The amount of the discount applied to the shopping cart.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The coupon applied to the shopping cart. For example, \"SUPER_DEALS\".")
  ...
  **/
  @ApiModelProperty(required = true, value = "The timestamp when the shopping cart was last updated, in milliseconds since epoch.")
