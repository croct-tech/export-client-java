 ...
 */
@ApiModel(description = "A geographic location represented by a latitude and longitude coordinates pair.")
@JsonPropertyOrder({
...
public class GeoPoint {
   ...
   * @return latitude
  **/
  @ApiModelProperty(required = true, value = "The latitude of the geo-point, may be either negative or positive.")
   ...
   * @return longitude
  **/
  @ApiModelProperty(required = true, value = "The longitude of the geo-point, may be either negative or positive.")
