...
public class OrderItem {
  ...
  public OrderItem index(@javax.annotation.Nonnull Integer index) {
    this.index = index;
    return this;
  }
  ...
  public OrderItem product(@javax.annotation.Nonnull ProductDetails product) {
  ...
  public OrderItem quantity(@javax.annotation.Nonnull Integer quantity) {
  ...
  public OrderItem total(@javax.annotation.Nonnull Double total) {
    this.total = total;
    return this;
  }
  ...
  public OrderItem discount(@javax.annotation.Nullable Double discount) {
  ...
  public OrderItem coupon(@javax.annotation.Nullable String coupon) {
    this.coupon = coupon;
    return this;
  }
