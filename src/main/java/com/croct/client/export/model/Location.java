 ...
 */
@ApiModel(description = "An identification or estimation of a geographic location of an object.")
@JsonPropertyOrder({
...
public class Location {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The highest administrative division, also known as a nation. The value is a two-letter country code, as defined in ISO 3166. For example, US for United States, BR for Brazil and DE for Germany.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The name of the incorporated city or town political entity. For example, \"Sao Paulo\".")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "An administrative division smaller than a city and larger than a neighborhood. For example, the district of Manhattan in New York.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(required = true, value = "The time-zone ID as defined in IANA Time Zone Database. For example, \"America/New_York\".")
