...
public class Location {
  ...
  private JsonNullable<Long> population = JsonNullable.<Long>undefined();
  ...
  public Location population(@javax.annotation.Nullable Long population) {
    this.population = JsonNullable.<Long>of(population);
    return this;
  }
  ...
  public JsonNullable<Long> getPopulation_JsonNullable() {
    return population;
  }
  
  @JsonProperty(JSON_PROPERTY_POPULATION)
  public void setPopulation_JsonNullable(JsonNullable<Long> population) {
